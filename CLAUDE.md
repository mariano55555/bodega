...
- This project is using the Pro version of Flux UI. It has full access to both the free and Pro components and variants.
- Flux UI is a component library for Livewire. Flux is a robust, hand-crafted, UI component library for your Livewire applications. It's built using Tailwind CSS and provides a set of components that are easy to use and customize.
- You should use any Flux UI component (free or Pro) when available.
...
- for all tables use softDeletes and also active_at for status and also slug when it makes sense for example if table has name or title field or similar then add slug to the table, and also add created_by, updated_by and deleted_by
- when design you can take a look at these sites for inspiration: https://tailwindcss.com/plus/ui-blocks/application-ui, https://fluxui.dev/demos, https://fluxui.dev/docs/installation, https://tailwindcss.com/plus/ui-blocks/ecommerce, https://tailwindcss.com/plus/ui-blocks/documentation
- all labels should be in spanish but all database fields should be in english, try to use code in english too