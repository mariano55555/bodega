...
class InventoryClosureDetail extends Model
{
    ...
    protected $casts = [
        ...
        'opening_unit_cost' => 'decimal:5',
        'opening_total_value' => 'decimal:5',
        'quantity_in' => 'decimal:5',
        'quantity_out' => 'decimal:5',
        'calculated_closing_quantity' => 'decimal:5',
        'calculated_closing_unit_cost' => 'decimal:5',
        'calculated_closing_value' => 'decimal:5',
        'physical_count_quantity' => 'decimal:5',
        'physical_count_unit_cost' => 'decimal:5',
        'physical_count_value' => 'decimal:5',
        'physical_count_date' => 'datetime',
        'discrepancy_quantity' => 'decimal:5',
        'discrepancy_value' => 'decimal:5',
        'has_discrepancy' => 'boolean',
        'adjusted_closing_quantity' => 'decimal:5',
        'adjusted_closing_unit_cost' => 'decimal:5',
        'adjusted_closing_value' => 'decimal:5',
        'is_adjusted' => 'boolean',
        'is_active' => 'boolean',
