...
class DispatchesSummaryByLineExport implements FromCollection, ShouldAutoSize, WithColumnWidths, WithDrawings, WithEvents, WithStyles, WithTitle
{
    ...
    {
        return 'Resumen Salidas por Línea';
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A4', 'REPORTE: RESUMEN SALIDAS POR LINEA PRESUPUESTARIA');
