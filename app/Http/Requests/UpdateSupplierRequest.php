...
class UpdateSupplierRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $supplierId = $this->route('supplier')?->id ?? $this->supplier;
    ...
    public function messages(): array
    {
        return [
            ...
            'tax_id.max' => 'El NIT no puede exceder 50 caracteres.',
            'tax_id.unique' => 'Ya existe un proveedor con este NIT en su compañía.',
            'nrc.max' => 'El NRC no puede exceder 20 caracteres.',
