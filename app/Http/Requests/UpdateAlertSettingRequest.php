...
class UpdateAlertSettingRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('edit alert settings') &&
               $this->user()->company_id === $this->route('alert_setting')->company_id;
    }
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'browser_notifications_enabled' => $this->boolean('browser_notifications_enabled'),
            'dashboard_alerts_enabled' => $this->boolean('dashboard_alerts_enabled'),
