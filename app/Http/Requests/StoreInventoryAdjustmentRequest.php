...
class StoreInventoryAdjustmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'adjustment_type' => ['required', 'string', 'in:physical_count,positive,negative,damage,expiry,loss,correction,return,other'],
    ...
    public function messages(): array
    {
        return [
            ...
            'adjustment_type.in' => 'El tipo de ajuste debe ser uno de los siguientes: conteo físico, positivo, negativo, daño, vencido, pérdida, corrección, devolución u otro.',
