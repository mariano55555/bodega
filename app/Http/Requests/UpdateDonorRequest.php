...
class UpdateDonorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $donorId = $this->route('donor')?->id ?? $this->donor;
        ...
        return [
            ...
            'tax_id' => [
                ...
                'string',
                'max:50',
                Rule::unique('donors', 'tax_id')->where(function ($query) use ($companyId) {
    ...
    {
        return [
            'name.required' => 'El nombre del donante es requerido.',
            'name.max' => 'El nombre no puede exceder 255 caracteres.',
            'legal_name.max' => 'El nombre legal no puede exceder 255 caracteres.',
            'donor_type.max' => 'El tipo de donante no puede exceder 50 caracteres.',
            'tax_id.max' => 'El NIT/DUI no puede exceder 50 caracteres.',
            'tax_id.unique' => 'Ya existe un donante con este NIT/DUI en su compañía.',
