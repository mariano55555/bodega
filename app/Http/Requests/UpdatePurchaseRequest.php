...
class UpdatePurchaseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'acquisition_type_id' => ['required', 'integer', 'exists:acquisition_types,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'purchase_type.in' => 'El tipo de compra debe ser contado o crédito.',
            'payment_method.max' => 'El método de pago no puede exceder 100 caracteres.',
            'acquisition_type_id.required' => 'El tipo de adquisición es requerido.',
            'acquisition_type_id.integer' => 'El tipo de adquisición debe ser un valor válido.',
            'acquisition_type_id.exists' => 'El tipo de adquisición seleccionado no existe.',
            ...
            'fund_source_id.integer' => 'El origen de fondos debe ser un valor válido.',
            'fund_source_id.exists' => 'El origen de fondos seleccionado no existe.',
