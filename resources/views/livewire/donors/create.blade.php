...
new #[Layout('components.layouts.app')] class extends Component
{
    ...
    {
        $validated = $this->validate((new StoreDonorRequest)->rules());
        ...
        session()->flash('success', 'Donante creado exitosamente.');
...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">Nuevo Donante</flux:heading>
            <flux:subheading class="mt-2">
                Complete la información del donante. Los campos marcados con (*) son obligatorios.
            </flux:subheading>
        </div>
    </div>
