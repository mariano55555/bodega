...
new #[Layout('components.layouts.app')] class extends Component
{
    ...
    public function save(): void
    {
        ...
        \DB::transaction(function () use ($companyId) {
            $production = InternalProduction::create([
            ...
            foreach ($this->details as $detail) {
                InternalProductionDetail::create([
                    'internal_production_id' => $production->id,
            ...
            $production->calculateTotals();

            session()->flash('success', 'Producción interna creada exitosamente.');
            $this->redirect(route('internal-productions.show', $production), navigate: true);
        });
    }
...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">Nueva Producción Interna</flux:heading>
            <flux:text class="mt-1">Registrar una nueva producción interna</flux:text>
        </div>

        <flux:button variant="ghost" href="{{ route('internal-productions.index') }}" wire:navigate>
            Cancelar
        </flux:button>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="flex items-center justify-between">
            <flux:button variant="ghost" href="{{ route('internal-productions.index') }}" wire:navigate type="button">
                Cancelar
            </flux:button>
