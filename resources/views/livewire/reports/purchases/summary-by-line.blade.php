...
new #[Layout('components.layouts.app')] class extends Component
{
    ...
    public function reportData()
    {
        ...
        // Get all purchase details with category information
        $query = PurchaseDetail::query()
            ...
            ->where('purchases.document_date', '>=', $this->start_date)
            ->where('purchases.document_date', '<=', $this->end_date)
            ->groupBy([
    ...
    public function exportPdf()
    {
        ...
        return $this->redirect(route('reports.purchases.summary-by-line.pdf', $params));
    }
    ...
    public function exportExcel()
    {
        ...
        return $this->redirect(route('reports.purchases.summary-by-line.excel', $params));
    }
}; ?>
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">Resumen Mensual por Línea Presupuestaria</flux:heading>
            <flux:text class="mt-1">Consolidado de compras agrupadas por categoría y línea presupuestaria</flux:text>
        </div>
        ...
        <flux:card>
            <div class="py-12 text-center">
                ...
                <flux:text class="mt-2">
                    Seleccione una empresa para ver el resumen por línea presupuestaria
                </flux:text>
            </div>
        </flux:card>
    @else
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        <div class="p-2 bg-blue-100 dark:bg-blue-900 rounded-lg">
                            <flux:icon name="folder" class="w-5 h-5 text-blue-600 dark:text-blue-400" />
                        </div>
                        <div>
        ...
        @if ($this->groupedByParent->count() > 0)
            <flux:card class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 border-green-200 dark:border-green-800">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="p-3 bg-green-100 dark:bg-green-900 rounded-xl">
                            <flux:icon name="calculator" class="w-6 h-6 text-green-600 dark:text-green-400" />
                        </div>
