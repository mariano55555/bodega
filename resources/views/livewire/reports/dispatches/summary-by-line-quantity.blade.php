...
new #[Layout('components.layouts.app')] class extends Component
{
    ...
    public function exportPdf()
    {
        ...
        return $this->redirect(route('reports.dispatches.summary-by-line-quantity.pdf', $params));
    }
    ...
    public function exportExcel()
    {
        ...
        return $this->redirect(route('reports.dispatches.summary-by-line-quantity.excel', $params));
    }
}; ?>
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl">Resumen Salidas Mensual por Línea Presupuestaria</flux:heading>
            <flux:text class="mt-1">Consolidado de cantidades de salidas por categoría y línea presupuestaria</flux:text>
        </div>
    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <flux:card class="text-center bg-amber-50 dark:bg-amber-900/20">
                <flux:text class="text-sm text-gray-500 dark:text-gray-400">Cantidad Total Mensual</flux:text>
                <flux:heading size="xl" class="text-amber-600 dark:text-amber-400">
                    {{ number_format($this->totals['total_quantity'], 2) }}
                </flux:heading>
            </flux:card>
        </div>
                ...
                <div class="overflow-x-auto">
                    <flux:table>
                        <flux:table.columns>
                            ...
                            <flux:table.column class="text-right">Cantidad Mensual</flux:table.column>
                        </flux:table.columns>
                            ...
                            @foreach ($group->lines as $line)
                                <flux:table.row :key="$line->category_id">
                                    ...
                                    <flux:table.cell class="text-right font-medium">
                                        {{ number_format($line->total_quantity, 2) }}
                                    </flux:table.cell>
                                </flux:table.row>
                            @endforeach
                        </flux:table.rows>
