...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .section-header-row td { background-color: #fff7ed; padding: 8px 12px; font-size: 10px; font-weight: bold; color: #92400e; border-left: 4px solid #d97706; border-bottom: none; }
        .subtotal-row { background-color: #fff7ed; font-weight: bold; }
        .subtotal-row td { padding: 8px 10px; border-top: 2px solid #fed7aa; }
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="title-cell">
                    ...
                    <div class="report-title">REPORTE: RESUMEN SALIDAS POR LINEA (CANTIDAD)</div>
        ...
        <table class="report-table">
            <thead>
                ...
                <tr class="columns-row">
                    ...
                    <th class="right" style="width: 25%;">Cantidad Mensual</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($groupedByParent as $parentName => $group)
                    ...
                    @foreach ($group->lines as $line)
                        <tr>
                            ...
                            <td class="right">{{ number_format($line->total_quantity, 2) }}</td>
                        </tr>
                    @endforeach
                ...
                <tr class="grand-total-row">
                    <td colspan="2" style="text-align: right;">Cantidad Total Mensual</td>
